...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hallo, ich bin Zaid.</span> Ich bin ein{" "}
        <span className="font-bold">Frontend-Entwickler.</span> Ich genieße,{" "}
        <span className="italic">Websites und Apps zu erstellen.</span>
      </motion.h1>
